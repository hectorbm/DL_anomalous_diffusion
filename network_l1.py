...
from generators import generator_first_layer, generate_batch_of_samples_l1
from tools.analysis_tools import plot_confusion_matrix_for_layer
from tools.load_model import load_model_from_file
import numpy as np


def train_l1_net(batch_size, track_length, track_time, model_id):
...
def validate_with_test_data_over_model(l1_net_model, n_axes, track_length, track_time):
    ...
    plot_confusion_matrix_for_layer(model=l1_net_model,
                                    layer_name='layer 1',
